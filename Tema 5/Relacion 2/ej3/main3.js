/**
 * Función auxiliar para alternar la visibilidad del texto y cambiar el texto del enlace.
 */
function alternarTexto(event) {
  ...
  if (spanOculto && enlace) {
    if (spanOculto.style.display === "none") {
      // Mostrar texto
      spanOculto.style.display = "inline";
      enlace.textContent = "Ocultar Articulo";
    } else {
      // Ocultar texto
...
function main() {
  ...
  h1.textContent = "Ejercicio 3 DOM - Mejora ejercicio 2 con ocultar texto";
